...
Encoder-decoder architectures have become the standard approach for medical image segmentation since Ronneberger et al.\ introduced U-Net \cite{ronneberger2015unet}. U-Net uses a downsampling path followed by a symmetric upsampling path, which enables precise localization even with very few annotated images. This architecture has been widely adopted in ophthalmic segmentation because it preserves fine spatial detail through skip connections.

...
\caption{Proposed dual-encoder architecture. Two parallel encoders process RGB and Canny edge maps. Cross-attention modules (orange) at stage 4 ($32^2$, 256ch) and bottleneck ($16^2$, 512ch) let RGB features query edge features. Dashed lines show skip connections from both encoders to each decoder stage.}

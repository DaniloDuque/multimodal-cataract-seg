...
\begin{table}[h]
\centering
\caption{Test set performance of all models. IoU is the primary metric. Best result per column in \textbf{bold}.}
\label{tab:results}
\begin{tabular}{lccc}
\hline
\textbf{Model} & \textbf{IoU} & \textbf{Dice} & \textbf{F1} \\
\hline
U-Net (RGB)           & 0.9529          & 0.9761          & 0.9759 \\
U-Net (Edge)          & 0.8817          & 0.9375          & 0.9371 \\
U-Net (Early Fusion)  & \textbf{0.9532} & \textbf{0.9763} & \textbf{0.9761} \\
